...
import type { VideoAnnotation } from './videoAnnotationTypes';
        ...
        return (
          <button
            ...
            style={{
              ...
              filter: isSelected ? 'drop-shadow(0 0 4px var(--color-primary))' : undefined,
            }}
...
export default VideoAnnotationTimeline;
